            ...
            S = function (e) {
                ...
                return (
                        ...
                        ((i[0] = parseInt(i[0])), (i[1] = parseInt(i[1]))),
                    {
                        placement: t,
                        strategy:
                            !0 === I(e, "overflow") ? "absolute" : "fixed",
                        modifiers: [
                            { name: "offset", options: { offset: i } },
                            {
                                name: "preventOverflow",
                                options: { altAxis: !1 !== I(e, "flip") },
                            },
        ...
        var i = {
            ...
            o = function (e) {
                ...
                if (!1 !== i)
                    if (
                        ...
                        if (
                            !1 === document.body.hasAttribute(n.attributeName)
                        ) {
                            if (!1 === a()) return;
            ...
            l = function () {
                ...
                var e = u("dependencies"),
                    t = u("class");
                if (
                    (null !== t && KTUtil.removeClass(n.element, t), null !== e)
                ) {
    ...
    return {
        ...
        createInstances: function () {
            [].slice
                ...
                r(),
                o(),
                !1 === t && (o(), window.addEventListener("scroll", o)),
                [].slice
                    .call(
                        document.querySelectorAll(
    ...
    return {
        init: function () {
            ...
            (e = document.querySelector("#kt_app_layout_builder_form")) &&
                ...
                s &&
                    (s.closest(".form-check-image").classList.add("active"),
                    (s.checked = !0)));
        },
    };
})();
    ...
    return {
        init: function () {
            ...
            null !== t) &&
                ...
                r &&
                    (l = r.querySelector(".menu-link.active")) &&
                    !0 !== KTUtil.isVisibleInContainer(l, r) &&
                    r.scroll({
                        top: KTUtil.getRelativeTopPosition(l, r),
                        behavior: "smooth",
                    }),
                i &&
