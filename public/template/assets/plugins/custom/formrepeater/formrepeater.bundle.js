    ...
    var e = function (t, e) {
            ...
            return (
                ...
                (e.publishChange = function (t, i) {
                    var a = r.get();
                    e.equalTo(a, n) ||
                        r.publish("change", { e: t, domElement: i }),
                        (n = a);
                }),
                r
            );
            ...
            return (
                r.is("input, select, textarea")
                    ? r.is('input[type="button"], button, input[type="submit"]')
                        ...
                        : r.is("textarea")
                        ? $("textarea", r)
                        : r.is('input[type="text"]') ||
                          (r.is("input") && !r.attr("type"))
                        ? $("text", r)
        ...
        return (
            ...
            $(this).each(function () {
                ...
                (e = function (t) {
                    ...
                    u(n.find("[data-repeater-create]"), t.repeaters).click(
                        function () {
                            v();
                        }
                    ),
