                ...
                (this.imageInitializing = {
                    ...
                    (t = zt(e, h, function (t, e) {
                        var i = t / e,
                            ...
                            a = O({}, n);
                        h.rotatable &&
                            ((n.rotate = d.rotate || 0), (a.rotate = 0)),
                            h.scalable &&
                                ((n.scaleX = d.scaleX || 1),
                                (n.scaleY = d.scaleY || 1),
                                (a.scaleX = 1),
                ...
                this.isShown &&
                    ...
                    !(
                        ...
                        : A(
                              ...
                              function (t) {
                                  X(t, y, e.loadImage.bind(e), { once: !0 }),
                                      P(t, y);
                              }
                          ));
            },
        ...
        It = {
            ...
            play: function () {
                ...
                return (
                    this.isShown &&
                        !this.played &&
                        ((t = this.element),
                        I((o = this.options).play) &&
                            X(t, "play", o.play, { once: !0 }),
                        !1 !== P(t, "play") &&
                            ((s = this.player),
            ...
            stop: function () {
                ...
                return (
                    this.played &&
                        ((t = this.element),
                        I((e = this.options).stop) &&
                            X(t, "stop", e.stop, { once: !0 }),
                        !1 !== P(t, "stop")) &&
                        ((e = this.player),
