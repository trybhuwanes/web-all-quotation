...
! function (d) {
    ...
    function w(e) {
        ...
        else x === ("" + p).slice(0, I) && p.slice(I).split(":")[0] in k ? (w = n(), b = w.id, k[b] && (k[b].loaded = !0), (h = w.type in {
            true: 1,
            false: 1,
            undefined: 1
    ...
    function N(e) {
        var n = e.id;
        if (!1 === T(n, "onClose", n)) O(n, "Close iframe cancelled by onClose event");
        else {
    ...
    function n() {
        ...
        return r ? r = r.bind(window) : O("setup", "RequestAnimationFrame not supported"), y(),
            function (e, n) {
                var i;
    ...
    }), z = {}, window.jQuery !== d && q(window.jQuery), "function" == typeof define && define.amd ? define([], n) : "object" == typeof module && "object" == typeof module.exports && (module.exports = n()), window.iFrameResize = window.iFrameResize || n())
}();
