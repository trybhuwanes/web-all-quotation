...
var KTUsersList = (function () {
    ...
    return {
        ...
        search: function (q) {
            ...
            const url = route("picproduct-additional.index", params);
        ...
        delete: function (data) {
            const id = data.id;
            const nama_additional_product = data.nama_additional_product;
            const url = route("product-additional.destroy", { id: id });
            Swal.fire({
                text: `Menghapus item ${nama_additional_product}.`,
                icon: "warning",
                showCancelButton: !0,
                buttonsStyling: !1,
                confirmButtonText: "Ya",
                ...
                t.value
                    ? axios.delete(url).then(({ data }) => {
                          if (data.success) {
                              Swal.fire({
                                  text: `Tidak menghapus item ${nama_additional_product}.`,
                                  icon: "success",
                                  buttonsStyling: !1,
                                  confirmButtonText: "Ok, lanjutkan!",
                                  customClass: {
...
KTUtil.onDOMContentLoaded(function () {
    ...
    $("#kt_table_users tbody").on("click", ".delete", function () {
        const data = {
            id: $(this).attr("data-kt-user-id"),
            nama_additional_product: $(this).attr("data-kt-user-name"),
        };
        console.log(data);
