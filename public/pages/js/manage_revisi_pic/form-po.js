...
var KTFileUpload = (function () {
    ...
    return {
        init: function () {
            ...
            if (!dropzoneInstance) {
                ...
                dropzoneInstance = new Dropzone("#kt_modal_po_files_upload", {
                    url: route("storage-dropzone-pdfs"), // Ganti dengan URL upload yang sesuai
                    paramName: "file",
        ...
        submitForm: function () {
            ...
            if (poId) {
                url = route("orders-po", { id: poId });
                formData.append("_method", "put");
                formData.append("id", poId);
            } else {
                url = route("orders-po"); // Route untuk create jika belum ada poId
            }
