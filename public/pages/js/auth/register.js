...
document.addEventListener("DOMContentLoaded", function () {
    const kotaByProvinsi = {
        "Nanggroe Aceh Darussalam": ["Banda Aceh", "Sabang", "Langsa", "Lhokseumawe", "Subulussalam", "Aceh Barat", "Aceh Barat Daya", "Aceh Besar", "Aceh Jaya", "Aceh Selatan", "Aceh Singkil", "Aceh Tamiang", "Aceh Tengah", "Aceh Tenggara", "Aceh Timur", "Aceh Utara", "Bener Meriah", "Bireuen", "Gayo Lues", "Nagan Raya", "Pidie", "Pidie Jaya", "Simeulue"],
        "Sumatera Utara": ["Medan", "Binjai", "Pematangsiantar", "Tanjung Balai", "Tebing Tinggi", "Gunungsitoli", "Asahan", "Batu Bara", "Dairi", "Deli Serdang", "Humbang Hasundutan", "Karo", "Labuhan Batu", "Labuhan Batu Selatan", "Labuhan Batu Utara", "Langkat", "Mandailing Natal", "Nias", "Nias Barat", "Nias Selatan", "Nias Utara", "Padang Lawas", "Padang Lawas Utara", "Pakpak Bharat", "Samosir", "Serdang Bedagai", "Simalungun", "Tapanuli Selatan", "Tapanuli Tengah", "Tapanuli Utara", "Toba"],
        "Sumatera Barat": ["Padang", "Bukittinggi", "Payakumbuh", "Solok", "Pariaman", "Agam", "Dharmasraya", "Kepulauan Mentawai", "Lima Puluh Kota", "Padang Pariaman", "Pasaman", "Pasaman Barat", "Pesisir Selatan", "Sijunjung", "Solok Selatan", "Tanah Datar"],
        "Riau": ["Pekanbaru", "Dumai", "Bengkalis", "Indragiri Hilir", "Indragiri Hulu", "Kampar", "Kuantan Singingi", "Pelalawan", "Rokan Hilir", "Rokan Hulu", "Siak"],
        ...
        "Jawa Barat": ["Bandung", "Bekasi", "Bogor", "Depok", "Cimahi", "Banjar", "Cirebon", "Sukabumi", "Tasikmalaya", "Bandung Barat", "Garut", "Karawang", "Kuningan", "Majalengka", "Subang", "Sumedang", "Indramayu", "Cianjur", "Ciamis", "Pangandaran", "Purwakarta"],
        "Jawa Tengah": ["Semarang", "Solo", "Magelang", "Tegal", "Pekalongan", "Salatiga", "Banyumas", "Batang", "Blora", "Boyolali", "Brebes", "Cilacap", "Demak", "Grobogan", "Jepara", "Karanganyar", "Kebumen", "Kendal", "Klaten", "Kudus", "Pati", "Pemalang", "Purbalingga", "Purworejo", "Rembang", "Sragen", "Sukoharjo", "Temanggung", "Wonogiri", "Wonosobo"],
        "Daerah Istimewa Yogyakarta": ["Yogyakarta", "Sleman", "Bantul", "Gunung Kidul", "Kulon Progo"],
        "Jawa Timur": ["Surabaya", "Malang", "Kediri", "Madiun", "Blitar", "Banyuwangi", "Bojonegoro", "Bondowoso", "Gresik", "Jember", "Jombang", "Lamongan", "Lumajang", "Magetan", "Mojokerto", "Nganjuk", "Ngawi", "Pacitan", "Pamekasan", "Pasuruan", "Ponorogo", "Probolinggo", "Sampang", "Sidoarjo", "Situbondo", "Sumenep", "Tuban", "Tulungagung"],
        "Bali": ["Denpasar", "Badung", "Bangli", "Buleleng", "Gianyar", "Jembrana", "Karangasem", "Klungkung", "Tabanan"],
        "Nusa Tenggara Barat": ["Mataram", "Bima", "Sumbawa", "Dompu", "Lombok Barat", "Lombok Tengah", "Lombok Timur", "Lombok Utara", "Sumbawa Barat"],
        ...
        "Sulawesi Barat": ["Mamuju", "Majene", "Polewali Mandar", "Mamasa", "Mamuju Tengah"],
        "Sulawesi Selatan": ["Makassar", "Parepare", "Palopo", "Bantaeng", "Barru", "Bone", "Bulukumba", "Enrekang", "Gowa", "Jeneponto", "Luwu", "Luwu Timur", "Luwu Utara", "Maros", "Pangkajene Kepulauan", "Pinrang", "Selayar", "Sidenreng Rappang", "Sinjai", "Soppeng", "Takalar", "Tana Toraja", "Toraja Utara", "Wajo"],
        ...
        "Papua Barat": ["Sorong", "Sorong Selatan", "Fakfak", "Kaimana", "Manokwari", "Manokwari Selatan", "Maybrat", "Pegunungan Arfak", "Raja Ampat", "Tambrauw", "Teluk Bintuni", "Teluk Wondama"],
        "Papua": ["Jayapura", "Deiyai", "Dogiyai", "Intan Jaya", "Jayapura", "Jayawijaya", "Keerom", "Lanny Jaya", "Mamberamo Raya", "Mamberamo Tengah", "Mappi", "Merauke", "Mimika", "Nabire", "Nduga", "Paniai", "Pegunungan Bintang", "Puncak", "Puncak Jaya", "Sarmi", "Supiori", "Tolikara", "Waropen", "Yahukimo", "Yalimo"],
        "Papua Tengah": ["Mimika", "Paniai", "Deiyai", "Dogiyai", "Intan Jaya", "Nabire", "Puncak", "Puncak Jaya"],
        "Papua Pegunungan": ["Jayawijaya", "Mamberamo Tengah", "Yalimo", "Lanny Jaya", "Nduga", "Pegunungan Bintang", "Tolikara"],
        "Papua Selatan": ["Merauke", "Boven Digoel", "Mappi", "Asmat"],
        "Papua Barat Daya": ["Sorong", "Raja Ampat", "Tambrauw", "Sorong Selatan", "Maybrat"]
    };
    

    const lokasiInstitusiSelect = $('#lokasi_institusi').select2();
    const kotaSelect = $('#kota').select2();

    $('#lokasi_institusi').on('change', function () {
        const provinsi = this.value;
        console.log("Provinsi yang dipilih: ", provinsi);  // Debug log
        updateKotaOptions(provinsi);
    });

    const updateKotaOptions = (provinsi) => {
        // Kosongkan opsi kota sebelum mengisi ulang
        ...
        if (provinsi && kotaByProvinsi[provinsi]) {
            kotaByProvinsi[provinsi].forEach(function(kota) {
                const option = new Option(kota, kota); // Buat opsi baru
