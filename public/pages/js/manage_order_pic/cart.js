...
var KTUsersList = (function () {
    ...
    return {
        delete: function (data) {
            ...
            const url = route("pic.cart.delete", { id: id });
        ...
        // Fungsi untuk mengubah quantity produk
        updateQuantity: function (id, action) {
            ...
            axios
                ...
                .then(({ data }) => {
                    if (data.success) {
                        window.location.reload(); // Refresh halaman setelah update quantity
                    }
                })
                .catch((error) => {
                    Swal.fire({
...
// Event listener untuk tombol delete dan update quantity
KTUtil.onDOMContentLoaded(function () {
    ...
    // Event listener untuk tombol decrease quantity
    ...
    // Event listener untuk tombol increase quantity
    $("#kt_table_carts tbody").on(
        "click",
