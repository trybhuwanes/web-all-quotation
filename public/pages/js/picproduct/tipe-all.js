...
var KTUsersList = (function () {
    ...
    return {
        init: function () {
            ...
            $("#kt_ecommerce_add_product_type .card-toolbar").on(
                "click",
                ".new",
                function () {
                    ...
                    const Url = route("picproduct.type.create", {
                        productId: productId,
                    });
            ...
            $("#kt_table_users tbody").on("click", ".edit", function () {
                ...
                // console.log(typeId);
                // Tentukan URL rute baru untuk create tipe
                const Url = route("picproduct.type.edit", {
                    productId: productId,
                    typeId: typeId,
                });
                // Arahkan ke rute tersebut
        ...
        search: function (q) {
            ...
            const url = route("picproduct.index", params);
            window.location.href = url;
        },
        edit: function (data) {
