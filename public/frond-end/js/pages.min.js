!(function($) {
    ...
    (Pages.prototype.setUserOS = function() {
        ...
        (Pages.prototype.isVisibleXs = function() {
            return (
                !$("#pg-visible-xs").length &&
                    this.$body.append(
                        '<div id="pg-visible-xs" class="visible-xs" />'
                    ),
                $("#pg-visible-xs").is(":visible")
            );
        }),
        (Pages.prototype.isVisibleSm = function() {
            return (
                !$("#pg-visible-sm").length &&
                    this.$body.append(
                        '<div id="pg-visible-sm" class="visible-sm" />'
                    ),
                $("#pg-visible-sm").is(":visible")
            );
        }),
        (Pages.prototype.isVisibleMd = function() {
            return (
                !$("#pg-visible-md").length &&
                    this.$body.append(
                        '<div id="pg-visible-md" class="visible-md" />'
                    ),
                $("#pg-visible-md").is(":visible")
            );
        }),
        (Pages.prototype.isVisibleLg = function() {
            return (
                !$("#pg-visible-lg").length &&
                    this.$body.append(
                        '<div id="pg-visible-lg" class="visible-lg" />'
                    ),
                $("#pg-visible-lg").is(":visible")
            );
        }),
        ...
        (Pages.prototype.getColor = function(color, opacity) {
            ...
            var elem = $(".pg-colors").length
                ...
                rgb = (color = (elem.find('[data-color="' + color + '"]').length
            ...
            $(".dropdown-default", context).each(function() {
                var btn = $(this)
                    ...
                    menuWidth = $(this)
                        .find(".dropdown-menu")
                        .actual("outerWidth");
                btn.actual("outerWidth") < menuWidth
                    ? (btn.width(menuWidth - 0),
                      $(this)
                          .find(".dropdown-menu")
                          .width(btn.actual("outerWidth")))
                    : $(this)
                          .find(".dropdown-menu")
                          .width(btn.actual("outerWidth"));
            });
        ...
        (Pages.prototype.initFormGroupDefault = function(context) {
            $(".form-group.form-group-default", context).click(function() {
                ...
                this.initFormGroupDefaultRun ||
                    ($("body").on(
                        "focus",
                        ".form-group.form-group-default :input",
                        function() {
                            $(".form-group.form-group-default").removeClass(
                                "focused"
                            ),
                                $(this)
                                    .parents(".form-group")
        ...
        (Pages.prototype.initSlidingTabs = function(context) {
            $('a[data-toggle="tab"]', context).on("show.bs.tab", function(e) {
                var hrefCurrent = (e = $(e.target)
                    .parent()
                    .find("a[data-toggle=tab]")).data("target");
                void 0 === hrefCurrent && (hrefCurrent = e.attr("href")),
                    $(hrefCurrent).is(".slide-left, .slide-right") &&
        ...
        (Pages.prototype.reponsiveTabs = function() {
            $('[data-init-reponsive-tabs="dropdownfx"]').each(function() {
                ...
                $(select).on("change", function(e) {
                    ...
                    $(select).wrap(
                        '<div class="nav-tab-dropdown cs-wrapper full-width hidden-md-up"></div>'
                    ),
                    new SelectFx(select);
            });
        }),
        (Pages.prototype.initNotificationCenter = function() {
            $("body").on("click", ".notification-list .dropdown-menu", function(
                event
            ) {
            ...
            $(document).on("change", ".btn-file :file", function() {
                ...
                $(".btn-file :file").on("fileselect", function(
                    ...
                    var input = $(this)
                            ...
                            .find(":text"),
                        log =
                            numFiles > 1 ? numFiles + " files selected" : label;
                    input.length
                        ? input.val(log)
                        : $(this)
                              .parent()
        ...
        (Pages.prototype.initHorizontalMenu = function() {
            function autoHideLi() {
                ...
                if (0 != hMenu.length) {
                    ...
                    if (
                        ...
                        var possibleLi =
                            parseInt(
                                hMenuRect.width / (liTotalWidth / liCount)
                            ) - 1;
            ...
            function _hideMenu($el) {
                ...
                if (0 != ul.length) {
                    ...
                    (timingSpeed = parseInt(1e3 * parseFloat(timingSpeed))),
                        $el.addClass("closing"),
            ...
            function _showMenu($el) {
                ...
                if (
                    ...
                    var rect = ul[0].getBoundingClientRect();
                    ghost.css({ width: rect.width + "px", height: "0px" }),
                        $el.append(ghost),
            ...
            $(window).on("resize", function(e) {
                ...
                $(".content").on("click", function() {
                    $(".horizontal-menu .bar-inner > ul > li").removeClass(
                        "open"
                    ),
                        $(".menu-bar > ul > li")
                            .removeClass("open opening")
                            ...
                            .removeAttr("style"),
                        $("body")
                            .find(".ghost-nav-dropdown")
                            .remove();
                }),
                $('[data-toggle="horizontal-menu"]').on(
                    "click touchstart",
                    function(e) {
                        e.preventDefault(),
                            $("body").toggleClass("horizontal-menu-open"),
                            $(".horizontal-menu-backdrop").length
                                ? $(".horizontal-menu-backdrop").fadeToggle(
                                      "fast",
                                      function() {
                                          $(this).remove();
                                      }
                                ...
                                : ($(".header").append(
                                      '<div class="horizontal-menu-backdrop"/>'
                                  ),
                                  $(".horizontal-menu-backdrop").fadeToggle(
                                      "fast"
                                  )),
        ...
        (Pages.prototype.initSelect2Plugin = function(context) {
            $.fn.select2 &&
                $('[data-init-plugin="select2"]', context).each(function() {
                    $(this)
                        .select2({
                            minimumResultsForSearch:
                                "true" == $(this).attr("data-disable-search")
                                    ? -1
                                    : 1
                        })
        ...
        (Pages.prototype.initScrollBarPlugin = function(context) {
            $.fn.scrollbar &&
                $(".scrollable", context).scrollbar({ ignoreOverlay: !1 });
        }),
        (Pages.prototype.initListView = function(context) {
            $.fn.ioslist &&
                $('[data-init-list-view="ioslist"]', context).ioslist(),
                $.fn.scrollbar &&
                    $(".list-view-wrapper", context).scrollbar({
                        ignoreOverlay: !1
                    });
        }),
        ...
        (Pages.prototype.initSelectFxPlugin = function(context) {
            window.SelectFx &&
                $('select[data-init-plugin="cs-select"]', context).each(
                    function() {
                        var el = $(this).get(0);
            ...
            $.validator &&
                $.validator.setDefaults({
                    ...
                    showErrors: function(errorMap, errorList) {
                        ...
                        return (
                            $.each(this.successList, function(index, value) {
                                if (
                                    $(this).closest(".form-group-attached")
                                        .length
                                )
                                    return $(value).popover("hide");
                            }),
                            $.each(errorList, function(index, value) {
                                var parent = $(value.element).closest(
                                    ".form-group-attached"
                                );
                                if (!parent.length)
                    ...
                    errorPlacement: function(error, element) {
                        var parent = $(element).closest(".form-group");
                        parent.hasClass("form-group-default")
                            ? (parent.addClass("has-error"),
        ...
        (Pages.prototype.setBackgroundImage = function() {
            $("[data-pages-bg-image]").each(function() {
                ...
                overlay.addClass(defaults.bgOverlayClass),
                    overlay.css({ "background-color": color, opacity: 1 }),
                    _elem.append(overlay);
                var img = new Image();
                (img.src = url),
                    (img.onload = function() {
                        _elem.css({ "background-image": "url(" + url + ")" }),
                            _elem
                                .children(".bg-overlay")
                                .css({ opacity: opacity });
                    });
                ...
                $('[data-init="secondary-sidebar-toggle"]').each(function() {
                    $(this).on("click", function(e) {
                        ...
                        if (menu.hasClass("open"))
                            menu.removeClass("open"), menu.removeAttr("style");
                        else {
                            menu.addClass("open");
                            ...
                            menu.css({
                                ...
                                "max-height":
                                    $(window).height() - toggleRect.bottom,
                                left:
                                    $(window).width() / 2 - menuRect.width / 2,
                                visibility: "visible"
                            });
                        }
                    });
        ...
        (SelectFx.prototype.options = {
            ...
            (SelectFx.prototype._init = function() {
                ...
                (this.hasDefaultPlaceholder =
                    ...
                    (this.selectedOpt =
                        selectedOpt || this.el.querySelector("option")),
            ...
            (SelectFx.prototype._createSelectEl = function() {
                ...
                var opts_el =
                    '<div class="cs-options"><ul>' + options + "</ul></div>";
                    ...
                    this.selEl.addEventListener("keydown", function(ev) {
                        switch (ev.keyCode || ev.which) {
                            ...
                            case 32:
                                ev.preventDefault(),
                                    self._isOpen() &&
                                        void 0 !== self.preSelCurrent &&
                                        -1 !== self.preSelCurrent &&
                                        self._changeOption(),
                                    self._toggleSelect();
                                break;
                            case 13:
                            ...
                            case 27:
                                ev.preventDefault(),
                                    self._isOpen() && self._toggleSelect();
                        }
                    });
            }),
            (SelectFx.prototype._navigateOpts = function(dir) {
                ...
                var tmpcurrent =
                    void 0 !== this.preSelCurrent && -1 !== this.preSelCurrent
                        ? this.preSelCurrent
                        : this.current;
                (("prev" === dir && tmpcurrent > 0) ||
                    ("next" === dir && tmpcurrent < this.selOptsCount - 1)) &&
                    ((this.preSelCurrent =
                        "next" === dir ? tmpcurrent + 1 : tmpcurrent - 1),
                    this._removeFocus(),
            ...
            (SelectFx.prototype._toggleSelect = function() {
                ...
                if (this._isOpen()) {
                    ...
                    (backdrop.style.transform = backdrop.style.webkitTransform = backdrop.style.MozTransform = backdrop.style.msTransform = backdrop.style.OTransform =
                        "scale3d(1,1,1)"),
                    ...
                    parentFormGroup &&
                        classie.removeClass(parentFormGroup, "focused");
                } else {
                    this.hasDefaultPlaceholder &&
                    ...
                    this.selEl.parentNode.querySelector(".dropdown-placeholder")
                        ? (dummy = this.selEl.parentNode.querySelector(
                    ...
                    var contentHeight = csOptions.offsetHeight,
                        ...
                        scaleV = (csOptions.offsetWidth,
                        csPlaceholder.offsetWidth,
                    ...
                    var resizedWidth =
                        csPlaceholderWidth < csOptionsWidth
                            ? csOptionsWidth
                            : csPlaceholderWidth;
            ...
            (SelectFx.prototype._changeOption = function() {
                ...
                oldOpt && classie.remove(oldOpt, "cs-selected"),
                    classie.add(opt, "cs-selected"),
                    opt.getAttribute("data-link") &&
                        (this.options.newTab
                            ? window.open(
                                  opt.getAttribute("data-link"),
                                  "_blank"
                              )
                            : (window.location = opt.getAttribute(
                                  "data-link"
                              ))),
            ...
            (this.$element = $(element)),
                ...
                this.$element.attr("data-color") &&
                    this.$container.addClass(
                        "progress-circle-" + this.$element.attr("data-color")
                    ),
                this.$element.attr("data-thick") &&
                    this.$container.addClass("progress-circle-thick"),
        ...
        var Notification = function(container, options) {
            ...
            function alignWrapperToContainer() {
                var containerPosition = self.container.position(),
                    ...
                    containerRight =
                        self.container.parent().width() -
                        (containerLeft + containerWidth);
                /top/.test(self.options.position) &&
                    self.wrapper.css("top", containerTop),
                    /bottom/.test(self.options.position) &&
                        self.wrapper.css("bottom", containerBottom),
                    /left/.test(self.options.position) &&
                        self.wrapper.css("left", containerLeft),
                    /right/.test(self.options.position) &&
            ...
            return (
                ...
                (self.notification = $(
                    '<div class="pgn push-on-sidebar-open"></div>'
                )),
                (self.options = $.extend(
                    !0,
                    {},
                ...
                "bar" == self.options.style
                    ...
                    : (self.options.style, new SimpleNotification()),
    ...
    (function($) {
        ...
        var Card = function(element, options) {
            (this.$element = $(element)),
                (this.options = $.extend(!0, {}, $.fn.card.defaults, options)),
                (this.$loader = null),
                (this.$body = this.$element.find(".card-block"));
        };
        (Card.VERSION = "1.0.0"),
            (Card.prototype.collapse = function() {
                var icon = this.$element.find(
                    this.options.collapseButton + " > i"
                );
            ...
            (Card.prototype.maximize = function() {
                var icon = this.$element.find(
                    this.options.maximizeButton + " > i"
                );
                if (this.$element.hasClass("card-maximized"))
                    this.$element.removeClass("card-maximized"),
                        this.$element.attr("style", ""),
                        icon
                            .removeClass("pg-fullscreen_restore")
                            .addClass("pg-fullscreen"),
                        $.isFunction(this.options.onRestore) &&
                    ...
                    sidebar &&
                        (sidebarWidth =
                            sidebar.position().left + sidebar.width());
                    var headerHeight = header.height();
                    this.$element.addClass("card-maximized"),
                        this.$element.css("left", sidebarWidth),
                        this.$element.css("top", headerHeight),
                        icon
                            .removeClass("pg-fullscreen")
                            .addClass("pg-fullscreen_restore"),
                        $.isFunction(this.options.onMaximize) &&
            ...
            (Card.prototype.refresh = function(refresh) {
                ...
                if (refresh) {
                    ...
                    if ("circle" == this.options.progress)
                        ...
                        toggle.find('[class$="-animated"]').length
                    ...
                    setTimeout(
                        ...
                        this.$loader.fadeIn(),
                        $.isFunction(this.options.onRefresh) &&
                    ...
                    this.$loader.fadeOut(function() {
                        if (
                            ($(this).remove(),
                            "circle-lg" == _this.options.progress)
                        ) {
        ...
        ($.fn.card = function(option) {
            return this.each(function() {
                var $this = $(this),
                    ...
                    options = "object" == typeof option && option;
                data || $this.data("pg.card", (data = new Card(this, options))),
                    "string" == typeof option
                        ? data[option]()
                        : options.hasOwnProperty("refresh")
            ...
            $(this.options.notes).on("click", ".list > ul > li", function(e) {
                ...
                $(this.options.deleteNoteButton).click(function(e) {
                    e.preventDefault(),
                        ...
                        $(_this.options.notes)
                            .find(".list > ul > li .checkbox")
                            .fadeToggle("fast"),
                        $(_this.options.deleteNoteConfirmButton)
                            .fadeToggle("fast")
                            .removeClass("hide");
                }),
                ...
                $(this.options.notes).on("click", ".toolbar > li > a", function(
                    e
                ) {
                    var command = $(this).attr("data-action");
                    document.execCommand(command, !1, null),
        ...
        ($.fn.quickview = function(option) {
            return this.each(function() {
                ...
                data ||
                    $this.data(
                        "pg.quickview",
                        (data = new Quickview(this, options))
                    ),
    ...
    (function($) {
        ...
        (Parallax.VERSION = "1.0.0"),
            (Parallax.prototype.animate = function() {
                var scrollPos,
                    opacityKeyFrame = (50 * this.$element.height()) / 100;
                (scrollPos = $(this.options.scrollElement).scrollTop()),
                    this.$coverPhoto.css({
                        transform:
                            "translateY(" +
                            scrollPos * this.options.speed.coverPhoto +
                            "px)"
                    }),
                    this.$content.css({
                        transform:
                            "translateY(" +
                            scrollPos * this.options.speed.content +
                            "px)"
                    }),
                    scrollPos > opacityKeyFrame
                        ? this.$content.css({ opacity: 1 - scrollPos / 1200 })
        ...
        ($.fn.parallax = function(option) {
            return this.each(function() {
                ...
                data ||
                    $this.data(
                        "pg.parallax",
                        (data = new Parallax(this, options))
                    ),
                    "string" == typeof option && data[option]();
            });
        }),
            ...
            ($.fn.parallax.defaults = {
                speed: { coverPhoto: 0.3, content: 0.17 },
    ...
    (function($) {
            ...
            if (
                ...
                "desktop" == $.Pages.getUserAgent() &&
                    this.$sidebarMenu.scrollbar({
                        ignoreOverlay: !1,
                        disableBodyScroll:
                            1 == this.$element.data("disableBodyScroll")
                    }),
                    ...
                    $(".sidebar-slide-toggle").on("click touchend", function(
                        e
                    ) {
                ...
                this.$element.bind("mouseenter mouseleave", function(e) {
                    var _sideBarWidthCondensed = _this.$body.hasClass("rtl")
                            ? -_this.sideBarWidthCondensed
                            : _this.sideBarWidthCondensed,
                        menuOpenCSS =
                            1 == this.css3d
                                ? "translate3d(" +
                                  _sideBarWidthCondensed +
                                  "px, 0,0)"
                                : "translate(" +
                                  _sideBarWidthCondensed +
                                  "px, 0)";
                    if ($.Pages.isVisibleSm() || $.Pages.isVisibleXs())
                        return !1;
                    $(".close-sidebar").data("clicked") ||
                        _this.$body.hasClass("menu-pin") ||
                        (_this.$element.css({ transform: menuOpenCSS }),
                    ...
                    this.$pageContainer.bind("mouseover", function(e) {
                        ...
                        if ($.Pages.isVisibleSm() || $.Pages.isVisibleXs())
                            return !1;
                        (void 0 !== e &&
                            $(e.target).parent(".page-sidebar").length) ||
                            _this.$body.hasClass("menu-pin") ||
                            ($(".sidebar-overlay-slide").hasClass("show") &&
                                ($(".sidebar-overlay-slide").removeClass(
                                    "show"
                                ),
                                $("[data-pages-toggle']").removeClass(
                                    "active"
                                )),
                            _this.$element.css({ transform: menuClosedCSS }),
        ...
        ($.fn.sidebar = function(option) {
            ...
            $(document).on(
                "click.pg.sidebar.data-api touchstart",
                '[data-toggle="sidebar"]',
                function(e) {
                    $(this);
                    return (
    ...
    (function($) {
        ...
        (Search.VERSION = "1.0.0"),
            (Search.prototype.init = function() {
                ...
                (this.pressedKeys = []),
                    (this.ignoredKeys = []),
                    (this.$searchField = this.$element.find(
                        this.options.searchField
                    )),
                    (this.$closeButton = this.$element.find(
                        this.options.closeButton
                    )),
                    (this.$suggestions = this.$element.find(
                      ...
                      setTimeout(
                          function() {
                              this.$element.is(":visible") &&
                                  this.$brand.toggleClass("invisible"),
                                  $(document).on("keypress.pg.search", function(
                                      e
                                  ) {
                                      _this.keypress(e);
                                  });
