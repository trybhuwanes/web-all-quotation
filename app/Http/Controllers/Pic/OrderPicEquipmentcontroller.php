...
class OrderPicEquipmentcontroller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pic.equipment.order.index', compact('orderall'));
    }
    ...
    {
        return view('pic.equipment.order.add_order');
    }
    ...
    public function show(string $id)
    {
        ...
        try {
            ...
            return view('pic.equipment.order.show', compact('orderdetail', 'productMainSpecification'));
        } catch (\Throwable $th) {
