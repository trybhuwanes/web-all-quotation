<x-app-layout>
                ...
                <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <x-data-table-card additionalButtons="custom_add">
                        ...
                        @slot('customAddButton')
                            <!--begin::Filter Status-->
                            <div class="w-150px">
                                <form method="GET" action="{{ route('order-pic.index') }}" id="filterForm">
                        ...
                        @slot('formCreate')
                            @include('pic.order-pic._form-chage-order')
                        @endslot


                        @slot('data')
                            @include('pic.order-pic._data-table')
                        @endslot
                    </x-data-table-card>
                </div>
    ...
    @push('js')
        ...
        <script src="{{ url('pages/js/manage_order_pic/mo.js') }}"></script>
        <!--end::Cust Javascript-->
