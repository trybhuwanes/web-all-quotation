        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container  container-xxl">
                ...
                <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10 mb-5">
                    ...
                    <div class="card card-flush py-4 bg-primarylight flex-row-fluid">
                        <!--begin::Card header-->
                        <div class="card-header">
                            <div class="card-title">
                                ...
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    <tbody class="fw-semibold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bold text-end">
                                                <a href="mailto:{{ $orderdetail->user->email }}" class="text-hover-warning text-white">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bold text-end text-white">{{ $orderdetail->user->phone}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <!--end::Table-->
                                                        ...
                                                        <td class="text-end">
                                                            @if ($item->productadd)
                                                                <div class="d-flex justify-content-end align-items-center">
                                                                    <button type="button" 
                                                                        class="btn btn-sm btn-icon btn-light-primary edit-additional-price me-2"
                                                                        data-bs-toggle="modal" 
                                                                        data-bs-target="#kt_modal_edit_additional_price"
                                                                        data-id="{{ $item->id }}"
                                                                        data-price="{{ $item->custom_price ?? $item->productadd->harga_produk_tambahan }}">
                                                                        <i class="ki-duotone ki-pencil fs-3"> <span class="path1"></span><span class="path2"></span></i>
                                                                    </button>
                                                                    <div class="fw-bold text-gray-800 me-2">
