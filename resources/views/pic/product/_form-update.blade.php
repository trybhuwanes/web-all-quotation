        ...
        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body text-center pt-0">
                    ...
                    <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                        ...
                        <div id="change-file-thumb" class="image-input-wrapper w-150px h-150px" style="background-image: url('{{ $product->getFirstMediaUrl('product-thumbnail') }}')"></div>
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <!--begin::Select2-->
                    <input type="hidden" id="current-category" value="{{ $product->category_id ? json_encode(App\Models\Category_product::find($product->category_id)) : '' }}">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="kt_ecommerce_add_product_general" role="tab-panel">
                    <div class="d-flex flex-column gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--begin::Input-->
                                    <input type="text" id="product-name" name="product-name" class="form-control mb-2"
                                        placeholder="Product name" value="{{$product->nama_produk}}" />
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <textarea id="product-description" class="form-control mb-2" rows="3" name="description"
                                        placeholder="Deskripsi Product">{{$product->deskripsi_produk}}</textarea>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" id="product-price" name="product-price" class="form-control mb-2"
                                        placeholder="Harga produk" value="{{$product->harga}}" />
                                    <!--end::Input-->

                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">Tetapkan harga produk.</div>
                                    <!--end::Description-->
                                    <span id="error-product_price"
                                        class="fv-plugins-message-container invalid-feedback"></span>
                                </div>
                                <!--end::Input group--> --}}
                        ...
                        <!--begin::Ringkasan Deskripsi-->
                        <div class="card card-flush py-4">
                            <!--begin::Card header-->
                            <div class="card-header">
                                <div class="card-title">
                                    <h2>{{ __('Ringkasan Deskripsi') }}</h2>
                                </div>
                            </div>
                            <!--end::Card header-->
                        ...
                        <!--end::Ringkasan Deskripsi-->
                         ...
                         <div class="card card-flush py-4">
                            ...
                            <div class="card-header">
                                <div class="card-title">
                                    <h2>{{ __('Spesifikasi Deskripsi') }}</h2>
                                </div>
                            </div>
                            <!--end::Card header-->
