...
<body>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $orderfind->items->contains('productadd.nama_produk_tambahan', 'Panel Control for Aerator') ? '√' : '' }}</td>
                        <td>{{ !$orderfind->items->contains('productadd.nama_produk_tambahan', 'Panel Control for Aerator') ? '√' : '' }}</td>
                        <td></td>
                    </tr>
                    <tr>
   ...
   <!-- End Halaman 10-->
    ...
    <button onclick="window.print();"
        class="print-hidden btn btn-outline btn-outline-info btn-active-light-info fw-bold"
