<x-app-layout>
        ...
        <div class="d-flex flex-column flex-column-fluid">
                             ...
                             <!--begin::Breadcrumb-->
                                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                    ...
                                    <li class="breadcrumb-item text-muted">
                                        <a href="{{ route('pic.dashboard') }}" class="text-muted text-hover-primary">Dashboard</a>
                                    </li>
                                    <!--end::Item-->
                                    <!--begin::Item-->
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <x-data-table-card additionalButtons="button_intro_js">
                        @slot('data')
                            @include('pic.client._data-table')
                        @endslot
                    </x-data-table-card>
                </div>
    ...
    @push('js')
        ...
        <script src="{{ url('pages/js/my_client/data-table.js') }}"></script>
