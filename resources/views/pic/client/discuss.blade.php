...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="card">
        ...
        <div class="card-body p-0 py-3">
            <!--begin::Form-->
            <form id="kt_inbox_compose_form" class="form" action="{{ route('discus.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="d-flex flex-stack flex-wrap gap-2 py-5 ps-8 pe-5 border-top">
                    ...
                    <div class="d-flex align-items-center me-3">
                        ...
                        <div class="btn-group me-4">
                            ...
                            <button type="submit" id="kt_diskusi_submit" class="btn btn-primary">
                                <span class="indicator-label">
                                    Submit
                                </span>
                                <span class="indicator-progress">
...
<script src="{{ url('pages/js/my_client/create-report.js') }}"></script>
<script src="{{ url('pages/js/my_client/isi-diskusi.js') }}"></script>
@endpush
</x-app-layout>