    ...
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
        ...
        <tbody class="text-gray-600 fw-semibold">
            ...
            @foreach ($additionalproducts as $additionalproduct)
                @if (!(strtolower($additionalproduct->nama_produk_tambahan) === 'panel control for aerator' &&
                    strtolower($additionalproduct->product->nama_produk ?? '') === 'flowrex surface aerator'
                ))
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('picproduct-additional.edit', $additionalproduct->uuid) }}" class="edit menu-link px-3" 
