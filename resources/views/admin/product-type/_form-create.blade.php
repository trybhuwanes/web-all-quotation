<div id="kt_form_create_product">
    <form id="kt_create_product_form" class="form d-flex flex-column flex-lg-row" action="{{ route('product.type.store') }}" enctype="multipart/form-data" class="form" method="POST">
        @csrf
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" id="harga" name="harga" class="form-control mb-2"
                                        placeholder="Harga tipe produk" value="" />
                                    <!--end::Input-->
                                ...
                                @foreach ($spesificationColumnsField as $field)
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        @if ($fieldTypes[$field] != 'decimal')
                                            <input type="text" id="{{ $field }}" name="{{ $field }}" class="form-control mb-2" placeholder="Masukan nilai {{ ucwords(str_replace('_', ' ', $field)) }}" value="" />
                                        @else
                                            <input type="number" step="0.1" id="{{ $field }}" name="{{ $field }}" class="form-control mb-2" placeholder="Masukan nilai {{ ucwords(str_replace('_', ' ', $field)) }}" value="" />
                                        @endif
                                        <!--end::Input-->
