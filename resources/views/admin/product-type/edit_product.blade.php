<x-app-layout>
        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    {{-- @slot('formCreate') --}}
                        @include('admin.product-type._form-update')
                    {{-- @endslot   --}}
                </div>
    ...
    @push('js')
        ...
        {{-- <script src="{{ url('pages/js/product-type/quill.js') }}"></script>
        <script>
            const i = document.getElementById('kt_create_product_form');
                i.addEventListener('submit', function(event) {
                    ...
                    if (e) {
                        const t = e.innerHTML;
                        document.getElementById('descriptionContent').value = t; // Simpan konten editor ke input hidden
