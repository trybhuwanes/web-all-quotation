<div id="kt_form_create_project">
    <form id="kt_create_project_form" class="form d-flex flex-column flex-lg-row" action="javascript:;" enctype="multipart/form-data" class="form">
        <!--begin::Main column-->
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <!--begin::Select2-->
                                {{-- <input type="hidden" id="kategori-barang" value="{{ $project->category_id ? json_encode(App\Models\Category_project::find($project->category_id)) : '' }}"> --}}
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Description-->
                                    <span id="error-project-name" class="fv-plugins-message-container invalid-feedback"></span>
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div id="deskripsi_editor" class="bg-transparent border-0 h-350px px-3"></div>
                                    <!--end::Input-->
                                    
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">Tetapkan deskripsi projek. Deskripsi projek bersifat opsional.</div>
                                    <!--end::Description-->
