    ...
    <table class="table table-striped align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
        ...
        <thead>
            ...
            <tr class="text-center fw-bold fs-7 text-uppercase gs-0">
                ...
                <th class="min-w-100px text-center">logo</th>
        ...
        <tbody class="text-gray-600 fw-semibold">
            <!--begin::Table row-->
            @foreach ($kategori as $kategoriproduct)
                <tr id="row-{{ str_replace(' ', '-', $kategoriproduct->key) }}">
                    ...
                    <td>
                        <div class="d-flex justify-content-start flex-column">
                            <a href="#" class="text-gray-900 fw-bold mb-1 fs-6">{{ $kategoriproduct->nama_kategori}}</a>
                            <a href="#" class="text-muted fw-semibold text-muted d-block fs-7">
                                <span class="text-gray-900">Desc</span>: {{ $kategoriproduct->deskripsi }}
                            </a>
                        </div>
                    </td>
                    <!--end::Name kategori-->
