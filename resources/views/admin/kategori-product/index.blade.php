<x-app-layout>
                ...
                <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                    ...
                    <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                        ...
                        <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                            <!--begin::Title-->
                            <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Kategori Produk</h1>
                            <!--end::Title-->
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <x-data-table-card additionalButtons="add">
                        ...
                        @slot('formCreate')
                            @include('admin.kategori-product._form-create')
                            @include('admin.kategori-product._show-data')
                        @endslot


                        @slot('data')
                            <h3 class="d-none d-lg-block text-black fs-3 fw-bolder text-center mb-7"> 
                                {{__('common.table-category')}}
                            </h3> 
                            @include('admin.kategori-product._data-table')
                        @endslot
                    </x-data-table-card>
                </div>
    ...
    @push('js')
        ...
        <script src="{{ url('pages/js/kategori_product/data-table.js') }}"></script>

        <script src="{{ url('pages/js/kategori_product/form-create.js') }}"></script>
        <!--end::Cust Javascript-->
