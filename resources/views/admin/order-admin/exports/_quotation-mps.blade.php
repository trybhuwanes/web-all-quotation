...
<body>
    ...
    <div class="cover-page page-break"
        ...
        <div class="cover-heading">
            QUOTATION <br> {{ $orderfind->items->first()->product->nama_produk }} -
    ...
    <div class="page mx-15 page-break">
        ...
        <div class="content-commercial">
            <h5 class="my-0">B. Commercial Quotation</h5>

            <p>The following is the price for <strong>{{ $orderfind->items->first()->product->nama_produk }} -
                ...
                <tbody>
                    @if ($orderfind->items->isNotEmpty())
                        ...
                        @if ($orderfind->shipping)
                            <tr>
                                <td colspan="4" class="text-end"><strong>Harga Produk Tambahan & Biaya
        ...
        <div class="content">
            <h5 class="my-0">C. Technical Data</h5>
            <table class="table table-bordered table-mps">
                <thead>
    ...
    <div class="page mx-15 page-break">
        ...
        <!-- Konten Utama -->
        <div class="content">
            <h5 class="mt-2">E. Scope of Supply</h5>
