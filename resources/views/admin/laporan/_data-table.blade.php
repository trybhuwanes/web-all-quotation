    ...
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
        ...
        <thead>
            ...
            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                ...
                <th class="min-w-100px">Nama Client</th>
        ...
        <tbody class="text-gray-600 fw-semibold">
            <!--begin::Table row-->
            @foreach ($allPresensiWithPic as $presensi)
                <tr id="row-{{ str_replace(' ', '-', $presensi->key) }}">
                    ...
                    <td>
                        <div class="d-flex justify-content-start flex-column">
                            <a href="#" class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">
                                @foreach ($presensi->users as $user)
                                {{ $user->name }}
                                @endforeach
                            </a>
                        </div>
                    ...
                    <!--begin::Button value-->
                        <td>
                            ...
                            <!--begin::Menu item-->
                            <a href="{{ route('laporan.show', $presensi->id) }}" class="btn btn-bg-light btn-color-muted btn-active-color-primary btn-sm px-4 me-2">
                                Show
                            </a>
                            <!--end::Menu item-->

                            <!--begin::Menu item PDF-->
                            <a href="{{ route('admin.laporan.export-pdf', $presensi->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
...
<!--end::Form-->
<!--begin::Pagination-->
{{ $allPresensiWithPic->links('components.pagination.bootstrap-5') }}
<!--end::Pagination-->
