<x-app-layout>
        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <x-data-table-card additionalButtons="export">
                        ...
                        @slot('data')
                            @include('admin.laporan._data-table')
                        @endslot
                    </x-data-table-card>
                </div>
    ...
    @push('js')
        ...
        <script src="{{ url('pages/js/laporan_admin/data-table.js') }}"></script>
        {{-- <script src="{{ url('pages/js/laporan_admin/index.js') }}"></script> --}}
