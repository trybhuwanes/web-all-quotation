    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <section class="mt-5">
            <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
                ...
                <li class="breadcrumb-item text-muted">{{ __('Textile Pulp and Paper Industry') }}</li>
            </ol>
                                        ...
                                        <div class="card-xl-stretch">
                                            ...
                                            <div class="my-3">
                                                ...
                                                <div class="fs-7 text-center text-gray-900">
                                                    {{ __('Solusi pengolahan air Limbah Domestik Terbaik') }}
                                                </div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Body-->
                            ...
                            <div class="col-md-3">
                                <div class="card shadow-sm hover-elevate card-rounded mb-3">
                                    <a class="d-block card-rounded" href="#">
                                        <div class="card-xl-stretch">
                                            <!--begin::Image-->
                                            <img alt="photo-product-grinviro" src="{{ url('/industry/product/mining/bioflux.webp') }}" class="rounded-4 border border-4 border-gray-200 w-100">
                                            <!--end::Image-->
                                            ...
                                            <div class="my-3">
                                                ...
                                                <!--begin::Text-->
                                                <div class="fs-7 text-center text-gray-900">
                                                    {{ __('Memberikan performa unggul dengan biaya operasional yang rendah') }}
                                                </div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Body-->
                            ...
                            <div class="col-md-3">
                                <div class="card shadow-sm hover-elevate card-rounded mb-3">
                                    <a class="d-block card-rounded" href="#">
                                        <div class="card-xl-stretch">
                                            <!--begin::Image-->
                                            <img alt="photo-product-grinviro" src="{{ url('/industry/product/mmf-acf.webp') }}" class="rounded-4 border border-4 border-gray-200 w-100">
                                            <!--end::Image-->
                                            ...
                                            <div class="my-3">
                                                ...
                                                <!--begin::Text-->
                                                <div class="fs-7 text-center text-gray-900">
                                                    {{ __('Multi media filter untuk menghilangkan zat-zat organik') }}
                                                </div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Body-->
