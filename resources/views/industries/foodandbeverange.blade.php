    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <section class="mt-5">
            <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-semibold">
                ...
                <li class="breadcrumb-item text-muted">{{ __('Food Beverage and Dairy Industry') }}</li>
            </ol>
                                ...
                                <a class="d-block card-rounded" href="#">
                                    <div class="card-xl-stretch">
                                        ...
                                        <div class="my-3">
                                            ...
                                            <!--begin::Text-->
                                            <div class="fs-7 text-center text-gray-900">
                                                {{ __('Teknologi dari sistem Teknologi Water Waste Treatment Plant (WWTP)') }}
                                            </div>
                                            <!--end::Text-->
                                        </div>
                                        <!--end::Body-->
                                ...
                                <a class="d-block card-rounded" href="#">
                                    <div class="card-xl-stretch">
                                        ...
                                        <div class="my-3">
                                            ...
                                            <!--begin::Text-->
                                            <div class="fs-7 text-center text-gray-900">
                                                {{ __('Teknologi Anamem menggunakan membran sebagai proses pemisahan biomass dalam reaktor') }}
                                            </div>
                                            <!--end::Text-->
                                        </div>
                                        <!--end::Body-->
